        ...
        <div className="grid grid-cols-4 ml-10">
          <div className="col-span-1 mt-12">
            ...
            <div className="mt-10 space-y-10">
              ...
              <ul className="space-y-10">
                ...
                <li className="text-xl font-normal mt-5">
                  Upholstery Material
                </li>
            ...
            <div>
              <div className="mt-28 ">
                <ul>
                  ...
                  <li className="text-xl font-normal mt-10">
                    Bright Grey & Lion
                  </li>
                </ul>
              </div>
              ...
              <div className="mt-36 ">
                <div>
                  <ul>
                    <li className="text-xl font-normal w-[226px]">
                      1 Year Manufacturing Warranty
                    </li>
                    <li className="text-xl font-normal  w-[241px] mt-9">
                      For Warranty Claims or Any Product Related Issues Please
                      Email at operations@trevifurniture.com
                    </li>
                    <li className="text-xl font-normal w-[241px] mt-10">
                      Warranty Against Manufacturing Defect
                    </li>
                    <li className="text-xl font-normal w-[241px] mt-16">
                ...
                <button className="bg-[#B88E2F] text-[#FFFFFF] w-[215px] h-[64px] mt-10">
                  Add To Cart
                </button>
              </div>
            </div>
          ...
          <div className="col-span-1 space-y-2">
            ...
            <div>
              ...
              <div className="mt-20 ">
                <ul className=" ">
                  <li className="text-xl font-normal w-[226px] mt-28">
              ...
              <div className="mt-36 ">
                <ul className="space-y-9 ">
                  ...
                  <li className="text-xl font-normal w-[241px] ">
                    For Warranty Claims or Any Product Related Issues Please
                ...
                <button className="bg-[#B88E2F] text-[#FFFFFF] w-[215px] h-[64px] mt-10 ml-12">
                  Add To Cart
                </button>
              </div>
            </div>
