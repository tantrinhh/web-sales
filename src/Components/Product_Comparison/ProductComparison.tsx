...
const ProductComparison = () => {
  return (
    <>
      ...
      <div className="grid grid-cols-4 container">
        ...
        <div className="col-span-1 mt-9">
          ...
          <div className="flex">
            ...
            <img src={stars} alt="" />
            <p className="border-l-[1px] border-[#9F9F9F] text-[13px] text-[#9F9F9F]">
              204 Review
            </p>
          </div>
        </div>
        ...
        <div className="col-span-1 mt-9">
          ...
          <div>
            <button
              type="button"
              className="inline-flex w-[242px] gap-x-20 rounded-md bg-[#B88E2F] px-3 py-2 text-sm font-semibold text-[#FFFFFF] shadow-sm ring-1 ring-inset ring-gray-300"
              id="menu-button"
              aria-expanded="true"
              aria-haspopup="true"
            >
      ...
      <div className="grid grid-cols-4  container">
        <div className="col-span-1 border-t-2 border-r-2 border-[#E8E8E8]">
